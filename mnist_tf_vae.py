...
class VariationalAutoencoder(object):
    ...
    def __init__(self, network_architecture, transfer_fct=tf.nn.softplus,
                 learning_rate=0.001, batch_size=100):  # TODO batch size = 64, learning rate = 0.01
        ...
        self.train_writer = tf.summary.FileWriter('/Users/olex/tb/train', self.sess.graph)
        self.test_writer = tf.summary.FileWriter('/Users/olex/tb/test')
    ...
    def partial_fit(self, X):
        ...
        summary, opt, cost = self.sess.run((self.merged, self.optimizer, self.cost),
                                           feed_dict={self.x: X})
        return summary, cost  # TODO proper names in passed params
...
def train(network_architecture, learning_rate=0.01,
    ...
    for epoch in range(training_epochs):
        ...
        for i in range(total_batch):
            ...
            opt, cost = vae.partial_fit(batch_xs)
            vae.train_writer.add_summary(opt, i)
